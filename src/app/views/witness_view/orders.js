...
const Orders = () => {
    const viewwitnesstransaction = useSelector(state => state.root.viewwitnesstransaction)

    return (
        <Card className="p-4">
            <div className="mb-4 flex justify-between items-center">
                <h4 className="m-0 font-medium">Order</h4>
                <div className="text-muted text-13 font-medium">
                    {
                        viewwitnesstransaction.transaction_update != null &&
            ...
            <div className="overflow-auto">
                {
                    viewwitnesstransaction.order.length > 0 &&
                    <div className="min-w-600">
                        ...
                        {viewwitnesstransaction.order.length > 0 && viewwitnesstransaction.order.map((product) => (
